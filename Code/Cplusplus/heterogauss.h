...
class HeteroGauss
{
	public:
		...
		void GibbsHIGLM(Eigen::MatrixXd &betaDraws, Eigen::MatrixXd &IbetaDraws, Eigen::MatrixXd &gammaDraws, Eigen::MatrixXd &IgammaDraws, Eigen::MatrixXd &rhoDraws, Eigen::MatrixXd &IrhoDraws, Eigen::VectorXd &accPrGammaDraws,  Eigen::VectorXd &beta, Eigen::VectorXd &u, Eigen::MatrixXd &U, Eigen::VectorXd &ytilde, Eigen::MatrixXd &Xtilde,   Eigen::VectorXd &rho,   Eigen::VectorXd &y, Eigen::MatrixXd &X, Eigen::MatrixXd Z, int ARorder, bool forceStationarity, Eigen::VectorXd &muBeta, Eigen::VectorXd &muGamma, double tauBeta, double tauGamma, double tauRho, double iota, double r, Eigen::VectorXd &PrInBeta, Eigen::VectorXd &PrInGamma, Eigen::VectorXd &PrInRho, Eigen::VectorXd &onTrialBeta, Eigen::VectorXd &onTrialGamma, Eigen::VectorXd &onTrialRho, int nIter, double prcBurnin, int nStepsGamma, int hessMethodGamma, int linkType, int propDfGamma, double IUpdatePrGamma, bool updateInclusion);

		void UpdateLinRegVarSel(Eigen::VectorXd &beta, Eigen::VectorXd &I, Eigen::VectorXd & y, Eigen::MatrixXd & X, Eigen::VectorXd & mu, Eigen::MatrixXd & Sigma, Eigen::VectorXd & PrIn, Eigen::VectorXd & onTrialIndex, bool AR, bool forceStationarity);
